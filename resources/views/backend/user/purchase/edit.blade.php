								...
								<table class="table" id="invoice-table">
									...
									<tbody>
										...
										<tr class="line-item">
											...
											<td class="input-xs text-center"><input type="number" class="form-control quantity" name="quantity[]" value="{{ $item->quantity }}" min="0.1" step=".01" {{ $item->product->type == 'product' && $item->product->stock_management == 1 ? 'max=' . $item->product->stock + $item->quantity : '' }}></td>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<select class="form-control discount_type" id="discount_type" name="discount_type" value="{{ $purchase->discount_type }}">
