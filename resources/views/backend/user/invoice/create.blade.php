...
@section('content')
<form method="post" class="validate" autocomplete="off" action="{{ route('invoices.store') }}" enctype="multipart/form-data">
	@csrf
	<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-4 offset-lg-4">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" name="invoice_number" value="{{ get_business_option('invoice_number', old('invoice_number')) }}" placeholder="{{ _lang('Invoice Number') }}" required>
									</div>
								</div>
					...
					<div class="row">
						...
						<div class="col-lg-6 offset-lg-2">
							...
							<div class="form-group row">
								...
								<div class="col-xl-8">
									<input type="text" class="form-control datepicker no-msg" name="due_date" value="{{ old('due_date') }}" required>
								</div>
							</div>
						</div>
					</div>
