...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center" href="{{ route('switch_language') }}?language={{ $language }}">
                                            <img class="avatar avatar-xss avatar-circle me-2" src="{{ asset('backend/plugins/flag-icon-css/flags/1x1/'.explode('---', $language)[1].'.svg') }}"> 
                ...
                <div class="container px-4">
                    <div class="inner">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="right">
                                    <img src="{{ isset($header_footer_media->payment_gateway_image) ? asset('uploads/media/'.$header_footer_media->payment_gateway_image) : asset('website/assets/payment_gateways.png') }}" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{ asset('website/js/jquery-3.6.3.min.js') }}"></script>
