            ...
            <div class="col-lg-8 col-xxl-6">
                <div class="text-center my-5">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="{{ url('/contact') }}">{{ _lang('Contact') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <input name="name" type="text" placeholder="{{ _lang('Your Name') }}" class="wow animate__zoomIn" data-wow-delay=".2s" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <input name="email" type="email" placeholder="{{ _lang('Your Email') }}" class="wow animate__zoomIn" data-wow-delay=".2s" required>
                                    </div>  
                                </div>
                                <div class="col-lg-12 col-12">
                                    <div class="form-group">
                                        <input name="subject" type="text" placeholder="{{ _lang('Your Subjects') }}" class="wow animate__zoomIn" data-wow-delay=".4s" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea name="message" placeholder="{{ _lang('Your Message') }}" class="wow animate__zoomIn" data-wow-delay=".6s" required></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <button type="submit" class="send-btn wow animate__zoomIn" data-wow-delay=".8s">{{ _lang('Send Message') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
