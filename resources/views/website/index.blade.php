    ...
    <div class="container px-4">
        <div class="row gx-5 align-items-center justify-content-center">
            ...
            <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center wow animate__fadeInRight" data-wow-delay="1s">
                <img class="img-fluid rounded-3" src="{{ isset($pageMedia->hero_image) ? asset('uploads/media/'.$pageMedia->hero_image) : asset('website/assets/hero-bg.jpg') }}" alt="Header Background" />
            </div>
        </div>
    </div>
</header>
            ...
            <div class="card single-testimonial h-100 mt-5">
                <div class="card-body d-flex align-items-center flex-column justify-content-center text-center">
                    <picture class="avatar">
                        <img class="img-fluid rounded-circle" src="{{ asset('uploads/media/'.$testimonial->image) }}" alt="{{ $testimonial->translation->name }}">
                    </picture>
